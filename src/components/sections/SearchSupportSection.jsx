...
const supportAreas = [
  {
    title: "한국 제작진을 위한 현지 지원",
    body: "KYEFILM은 한국 방송사와 제작팀이 독일·유럽에서 현지 소통, 허가, 일정, 물류, 언어 문제를 최소화하도록 실무 중심으로 지원합니다.",
  },
  {
    title: "독일·유럽 현지 촬영 대행",
    body: "한국 팀이 독일에 직접 오기 어려울 때 함부르크를 기반으로 인터뷰, 현장 스케치, 기업 영상, 뉴스 리포트용 촬영을 직접 진행해 전달합니다.",
  },
  {
    title: "독일·오스트리아·스위스·프랑스 촬영 지원",
    body: "독일 전역과 오스트리아, 스위스, 프랑스 등 유럽 주요 도시에서 방송 촬영, 브랜드 캠페인, 기업 홍보영상, 유튜브 콘텐츠 제작에 필요한 현지 진행을 함께합니다.",
  },
  {
    title: "로케이션 헌팅과 인터뷰 섭외",
